...
import 'package:usaer_pannel/screen/search_screen.dart';
import 'package:usaer_pannel/widgets/list_tile.dart';
import 'package:usaer_pannel/widgets/single_product.dart';
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.only(topLeft: Radius.circular(11), bottomRight: Radius.circular(20), bottomLeft: Radius.circular(20))
              ...
              SizedBox(height: 10,),
               Row(
                ...
                children: [
                  ...
                  Text('Fresh Fruits', style: TextStyle(fontSize: 18),),
                  Text('view all', style: TextStyle(fontSize: 14, color: Colors.grey),)
                ],
              ),
                SizedBox(height: 10,),
