...
class SingleProduct extends StatelessWidget {
  ...
  const SingleProduct({super.key, required this.productImage, required this.productName, required this.onTap});
                       ...
                       Expanded(
                         child: Row(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Icon(Icons.remove, size: 14, color: Colors.amber,),
                              Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 10),
                                child: Text('1', style: TextStyle(color: Colors.amber, fontSize: 17)),
                              ),
                              Text('+', style: TextStyle(color: Colors.amber, fontSize: 17))
                            ],
                          ),
                          )
                          ),
